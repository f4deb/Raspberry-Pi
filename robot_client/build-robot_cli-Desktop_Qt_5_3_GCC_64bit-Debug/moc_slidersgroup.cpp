...
#include "../robot_cli_0.2/slidersgroup.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SlidersGroup_t, stringdata) + ofs \
...
const QMetaObject SlidersGroup::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_SlidersGroup.data,
      qt_meta_data_SlidersGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SlidersGroup.stringdata))
